...
const Register = () => {
  ...
  return (
    <div className="min-h-screen relative flex bg-[#F7F8FA] dark:bg-[#0F1115] transition-colors select-none">
      ...
      {/* Right Panel - Register Form (45% desktop) */}
      <div className="w-full lg:w-[45%] flex items-center justify-center p-6 sm:p-12 overflow-y-auto relative z-10 my-auto py-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <select
                ...
                className="w-full h-[46px] px-3.5 text-xs bg-white dark:bg-[#1B1F27] text-[#111827] dark:text-[#F5F7FA] rounded-xl border border-[#D0D5DD] dark:border-[#2A303A] focus:outline-none focus:ring-2 focus:ring-[#2563EB] focus:border-[#2563EB] transition-all font-semibold"
              >
